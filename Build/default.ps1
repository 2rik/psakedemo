...
#  		
task Init -description "Initialises the build by removing previous argifacts and creating output directories"`
		  -requiredVariables outputDirectory, tempOutputDirectory {
		
	    Assert("Debug", "Release" -contains $buildConfiguration) `
			  "Invalid build configuration '$buildConfiguration'"
		...
		{
			Write-Host "Deleting output directory located at $outputDirectory"
